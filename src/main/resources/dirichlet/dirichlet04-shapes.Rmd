...
```{r c.dirichlet.shapes.q1.fig1, fig.width=2, fig.height=1.2, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
...
```{r c.dirichlet.shapes.q2.fig1, fig.width=2, fig.height=1, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
pushViewport(mainVP)
...
```{r c.dirichlet.shapes.q5.fig1, fig.width=2, fig.height=1.555555, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
...
```{r c.dirichlet.shapes.q5.fig2, fig.width=2, fig.height=1.555555, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
require(RColorBrewer)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
...
```{r c.dirichlet.shapes.q5.fig3, fig.width=1.4, fig.height=1.555555, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
require(RColorBrewer)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
...
```{r c.dirichlet.shapes.q6.fig1, fig.width=2, fig.height=1.555555, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
require(RColorBrewer)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
...
```{r c.dirichlet.shapes.q6.fig2, fig.width=2, fig.height=1.555555, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
require(RColorBrewer)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
...
```{r c.dirichlet.shapes.q6.fig3, fig.width=1.4, fig.height=1.555555, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
require(RColorBrewer)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
...
```{r c.dirichlet.shapes.q7.fig1, fig.width=2, fig.height=1.555555, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
require(RColorBrewer)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
...
```{r c.dirichlet.shapes.q7.fig3, fig.width=1.4, fig.height=1.555555, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
require(RColorBrewer)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
...
```{r c.dirichlet.shapes.q10.fig1, fig.width=0.7, fig.height=0.7, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
pushViewport(mainVP)
...
## c.dirichlet.shapes.q11 (MULTIPART)
...
## c.dirichlet.shapes.q13 (MULTIPART)
Dots šaha galdiņš $8 \times 8$, kurā kaut kā atzīmētas $n$
...
__Kvadrātiņš $1 \times 1$ (1.zīm.)__ (INPUT,2)

__Taisnstūrītis $1 \times 2$ (2.zīm.)__ (INPUT,2)

__"Stūrītis" - figūriņa no $3$ rūtiņām (3.zīm.)__ (INPUT,2)

__Kvadrātiņš $2 \times 2$ (4.zīm.)__ (INPUT,2)

```{r c.dirichlet.shapes.q13.fig1, fig.width=1.2, fig.height=1, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
pushViewport(mainVP)
...
```{r c.dirichlet.shapes.q13.fig5, fig.width=1.8, fig.height=2, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
require(RColorBrewer)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
...
```{r c.dirichlet.shapes.q15.fig2, fig.width=2, fig.height=2, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
pushViewport(mainVP)
