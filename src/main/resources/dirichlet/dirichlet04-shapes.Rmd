...
```{r, fig.width=2, fig.height=1.2, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
...
```{r, fig.width=2, fig.height=1, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
pushViewport(mainVP)
...
```{r, fig.width=1.98, fig.height=2.2, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
pushViewport(mainVP)
...
```{r, fig.width=2, fig.height=1.555555, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
...
```{r, fig.width=1.4, fig.height=1.555555, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
require(RColorBrewer)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
...
```{r, fig.width=0.7, fig.height=0.7, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
pushViewport(mainVP)
...
```{r, fig.width=1.2, fig.height=1, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
pushViewport(mainVP)
...
```{r, fig.width=1.8, fig.height=2, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
require(RColorBrewer)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
...
```{r, fig.width=2, fig.height=2, echo=FALSE, message=FALSE, warning=FALSE}
require(grid)
grid.newpage()
mainVP <- viewport(name="mainVP", width = 1, height = 1)
pushViewport(mainVP)
