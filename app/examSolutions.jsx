...
import {getCompleteExamItems} from './examlistApi11.js'


class ExamSolutions extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            "yourAnswers": ["","","","","","","","","","","","","","","","","","","",""],
                    ...
                    <div className="carousel-inner" role="listbox">
                        {this.state.questions.map(function(qq,i) {
                            ...
                            if (qq.questionType == "MC" || qq.questionType == "MC" ) {
                                theAlternatives = <ol type="a">{qq.alternatives.map(function(alter, i) {
                                    return <li>{alter}</li>
                                })}</ol>
                            }
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-xs-12">
                                            ...
                                            Atbilde: '{qq.answer}'
                                            <br/>
                                            <b>Skaidrojums:</b> <div dangerouslySetInnerHTML={{__html: qq.explanation}}></div>
